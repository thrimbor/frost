namespace paging
    ...
    declare function map_page_range (page_directory as uinteger ptr, v_addr as uinteger, p_addr as uinteger, num_pages as uinteger, flags as uinteger) as integer
